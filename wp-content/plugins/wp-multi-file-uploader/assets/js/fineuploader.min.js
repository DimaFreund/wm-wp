...
var qq = function(e) {
    ...
    return {
        ...
        contains: function(t) {
            return e === t ? !0 : e.contains ? e.contains(t) : !!(t.compareDocumentPosition(e) & 8)
        },
        ...
        css: function(t) {
            t.opacity !== null && typeof e.style.opacity != "string" && typeof e.filters != "undefined" && (t.filter = "alpha(opacity=" + Math.round(100 * t.opacity) + ")");
            qq.extend(e.style, t);
            return this
        },
        hasClass: function(t) {
...
qq.log = function(e, t) {
    "use strict";
    window.console && (!t || t === "info" ? window.console.log(e) : window.console[t] ? window.console[t] : window.console.log("<" + t + "> " + e))
};
...
qq.isFileOrInput = function(e) {
    "use strict";
    if (window.File && e instanceof File) return !0;
    if (window.HTMLInputElement) {
        if (e instanceof HTMLInputElement && e.type && e.type.toLowerCase() === "file") return !0
    } else if (e.tagName && e.tagName.toLowerCase() === "input" && e.type && e.type.toLowerCase() === "file") return !0;
    return !1
};
...
qq.obj2url = function(e, t, n) {
    ...
    var r, i, s = [],
        ...
        u = function(e, n) {
            ...
            r !== "undefined" && n !== "undefined" && s.push(typeof e == "object" ? qq.obj2url(e, r, !0) : Object.prototype.toString.call(e) === "[object Function]" ? encodeURIComponent(r) + "=" + encodeURIComponent(e()) : encodeURIComponent(r) + "=" + encodeURIComponent(e))
        };
    if (!n && t) {
        o = /\?/.test(t) ? /\?$/.test(t) ? "" : "&" : "?";
        s.push(t);
        ...
        for (r = -1, i = e.length; r < i; r += 1) u(e[r], r);
    else if (typeof e != "undefined" && e !== null && typeof e == "object")
        for (r in e) e.hasOwnProperty(r) && u(e[r], r);
    else s.push(encodeURIComponent(t) + "=" + encodeURIComponent(e));
    return t ? s.join(o) : s.join(o).replace(/^&/, "").replace(/%20/g, "+")
};
qq.obj2FormData = function(e, t, n) {
    ...
    qq.each(e, function(e, r) {
        e = n ? n + "[" + e + "]" : e;
        qq.isObject(r) ? qq.obj2FormData(r, t, e) : qq.isFunction(r) ? t.append(encodeURIComponent(e), encodeURIComponent(r())) : t.append(encodeURIComponent(e), encodeURIComponent(r))
    });
    return t
};
...
qq.parseJson = function(json) {
    return typeof JSON.parse == "function" ? JSON.parse(json) : eval("(" + json + ")")
};
...
qq.UploadHandler = function(e) {
    ...
    qq.isXhrUploadSupported() ? s = new qq.UploadHandlerXhr(n, i, r) : s = new qq.UploadHandlerForm(n, i, r);
    return {
        add: function(e) {
            return s.add(e)
        },
        upload: function(e) {
            var r = t.push(e);
            if (r <= n.maxConnections) return s.upload(e)
        },
        retry: function(e) {
            var n = qq.indexOf(t, e);
            return n >= 0 ? s.upload(e, !0) : this.upload(e)
        },
        cancel: function(e) {
            r("Cancelling " + e);
...
qq.UploadHandlerForm = function(o, uploadCompleteCallback, logCallback) {
    ...
    function createForm(e, t) {
        var n = options.paramsStore.getParams(e),
            r = options.demoMode ? "GET" : "POST",
            i = qq.toElement('<form method="' + r + '" enctype="multipart/form-data"></form>'),
            s = options.endpointStore.getEndpoint(e),
            o = s;
        n[options.uuidParamName] = uuids[e];
        options.paramsInBody ? qq.obj2Inputs(n, i) : o = qq.obj2url(n, s);
    ...
    api = {
        ...
        upload: function(e) {
            var t = inputs[e],
                ...
                r = createIframe(e),
                i = createForm(e, r);
            if (!t) throw new Error("file with passed id was not added, or already uploaded or cancelled");
            ...
            attachLoadEvent(r, function() {
                ...
                if (!t.success && options.onAutoRetry(e, n, t)) return;
...
qq.UploadHandlerXhr = function(e, t, n) {
    ...
    function p(e, t, n) {
        ...
        c && (t[r.chunking.paramNames.filename] = s)
    }

    function d(e) {
        e[r.resume.paramNames.resuming] = !0
    }

    function v(e, t, n) {
        if (e.slice) return e.slice(t, n);
        if (e.mozSlice) return e.mozSlice(t, n);
        if (e.webkitSlice) return e.webkitSlice(t, n)
    }

    function m(e, t) {
        var n = r.chunking.partSize,
            i = h.getSize(e),
            s = o[e].file,
            u = n * t,
            a = u + n >= i ? i : u + n,
    ...
    function b(e, t, n, i) {
        var s = new FormData,
            u = r.demoMode ? "GET" : "POST",
            a = r.endpointStore.getEndpoint(i),
            f = a,
            l = h.getName(i),
            p = h.getSize(i);
        e[r.uuidParamName] = o[i].uuid;
        c && (e[r.totalFileSizeParamName] = p);
        if (!r.paramsInBody) {
            e[r.inputName] = l;
            f = qq.obj2url(e, a)
        }
        t.open(u, f, !0);
        if (c) {
            r.paramsInBody && qq.obj2FormData(e, s);
    ...
    function S(e) {
        var t = m(e, o[e].remainingChunkIdxs[0]),
            n = y(e),
            i = h.getSize(e),
            u = h.getName(e),
            a, f;
        o[e].loaded === undefined && (o[e].loaded = 0);
        _(e, t);
        n.onreadystatechange = M(e, n);
        n.upload.onprogress = function(t) {
            if (t.lengthComputable && o[e].loaded < i) {
    ...
    function x(e, t, n) {
        var r = o[e].remainingChunkIdxs.shift(),
            i = m(e, r);
        o[e].attemptingResume = !1;
        o[e].loaded += i.end - i.start;
        if (o[e].remainingChunkIdxs.length > 0) S(e);
        else {
            D(e);
            E(e, t, n)
        }
    ...
    function L(e, t, n) {
        var i = h.getName(e);
        if (r.onAutoRetry(e, i, t, n)) return;
        E(e, t, n)
    }
    ...
    function A(e, t) {
        ...
        if (T(t, n)) {
            n.reset && C(e);
            o[e].attemptingResume && n.reset ? k(e) : L(e, n, t)
        } else a ? x(e, n, t) : E(e, n, t)
    }
    ...
    function B() {
        if (r.resume.id !== null && r.resume.id !== undefined && !qq.isFunction(r.resume.id) && !qq.isObject(r.resume.id)) return r.resume.id
    }
    ...
    function j(e, t) {
        ...
        if (!o[e].remainingChunkIdxs || o[e].remainingChunkIdxs.length === 0) {
            ...
            if (f && !t) {
                ...
                if (u) {
                    a = m(e, u.part);
                    if (r.onResume(e, n, O(a)) !== !1) {
                        i = u.part;
                        o[e].uuid = u.uuid;
                        o[e].loaded = a.start;
                        o[e].attemptingResume = !0;
    ...
    function F(e) {
        ...
        i.upload.onUpload = function (t, n) {
            console.log(t, n, 'test');
        };
        i.upload.onResume = function (t, n, r) {
            console.log(t, n, r, 'test');
        };
        i.upload.onComplete = function() {
            console.log('test');
        }
    ...
    var r = e,
        ...
        o = [],
        u = "|",
        a = r.chunking.enabled && qq.isFileChunkingSupported(),
        f = r.resume.enabled && a && qq.areCookiesEnabled(),
        l = B(),
        c = r.forceMultipart || r.paramsInBody,
        h;
    h = {
        add: function(e) {
        ...
        getResumableFilesData: function() {
            var e = [],
                t = [];
            if (a && f) {
                l === undefined ? e = qq.getCookieNames(new RegExp("^qqfilechunk\\" + u + ".+\\" + u + "\\d+\\" + u + r.chunking.partSize + "=")) : e = qq.getCookieNames(new RegExp("^qqfilechunk\\" + u + ".+\\" + u + "\\d+\\" + u + r.chunking.partSize + "\\" + u + l + "="));
                qq.each(e, function(e, n) {
                    var r = n.split(u),
                        i = qq.getCookie(n).split(u);
                    t.push({
                        name: decodeURIComponent(r[1]),
                        size: r[2],
                        uuid: i[0],
                        partIdx: i[1]
                    })
...
qq.FineUploaderBasic = function(e) {
    ...
    this._options = {
        ...
        formatFileName: function(e) {
            e.length > 33 && (e = e.slice(0, 19) + "..." + e.slice(-14));
            return e
        },
        text: {
...
qq.FineUploaderBasic.prototype = {
    log: function(e, t) {
        this._options.debug && (!t || t === "info") ? qq.log("[FineUploader] " + e) : t && t !== "info" && qq.log("[FineUploader] " + e, t)
    },
    setParams: function(e, t) {
        t == null ? this._options.request.params = e : this._paramsStore.setParams(e, t)
    },
    setEndpoint: function(e, t) {
        t == null ? this._options.request.endpoint = e : this._endpointStore.setEndpoint(e, t)
    },
    ...
    addFiles: function(e) {
        var t = this,
            ...
            r, i;
        if (e) {
            if (!window.FileList || !(e instanceof FileList)) e = [].concat(e);
            for (r = 0; r < e.length; r += 1) {
                i = e[r];
                qq.isFileOrInput(i) ? n.push(i) : t.log(i + " is not a File or INPUT element!  Ignoring!", "warn")
            }
    ...
    _preventLeaveInProgress: function() {
        ...
        this._disposeSupport.attach(window, "beforeunload", function(t) {
            if (!e._filesInProgress.length) return;
    ...
    _onSubmit: function(e, t) {
        this._options.autoUpload && this._filesInProgress.push(e)
    },
    ...
    _onInputChange: function(e) {
        qq.isXhrUploadSupported() ? this.addFiles(e.files) : this.addFiles(e);
        this._button.reset()
    },
    ...
    _shouldAutoRetry: function(e, t, n) {
        if (!this._preventRetries[e] && this._options.retry.enableAuto) {
            this._autoRetries[e] === undefined && (this._autoRetries[e] = 0);
    ...
    _onBeforeManualRetry: function(e) {
        ...
        if (this._handler.isValid(e)) {
            ...
            if (this._options.callbacks.onManualRetry(e, t) === !1) return !1;
    ...
    _maybeParseAndSendUploadError: function(e, t, n, r) {
        if (!n.success)
            if (r && r.status !== 200 && !n.error) this._options.callbacks.onError(e, t, "XHR returned response code " + r.status);
            else {
    ...
    _uploadFileList: function(e) {
        ...
        r = this._options.callbacks.onValidateBatch(t) === !1;
        if (!r)
            if (e.length > 0) {
                for (n = 0; n < e.length; n++)
                    if (this._validateFile(e[n])) this._uploadFile(e[n]);
    ...
    _uploadFile: function(e) {
        ...
        if (this._options.callbacks.onSubmit(t, n) !== !1) {
            this._onSubmit(t, n);
            this._options.autoUpload ? this._handler.upload(t) : this._storeFileForLater(t)
        }
    },
    ...
    _validateFile: function(e) {
        ...
        n = t.name;
        r = t.size;
        if (this._options.callbacks.onValidate(t) === !1) return !1;
        ...
        if (r && this._options.validation.sizeLimit && r > this._options.validation.sizeLimit) {
            this._error("sizeError", n);
            return !1
        }
        if (r && r < this._options.validation.minSizeLimit) {
    ...
    _error: function(e, t) {
        ...
        var n = this._options.messages[e],
            i = this._options.validation.allowedExtensions.join(", ").toLowerCase();
    ...
    _parseFileName: function(e) {
        var t;
        e.value ? t = e.value.replace(/.*(\/|\\)/, "") : t = e.fileName !== null && e.fileName !== undefined ? e.fileName : e.name;
        return t
    },
    _parseFileSize: function(e) {
        var t;
        e.value || (t = e.fileSize !== null && e.fileSize !== undefined ? e.fileSize : e.size);
        return t
    },
    ...
    _createParamsStore: function() {
        ...
        return {
            ...
            getParams: function(n) {
                var r = {};
                n != null && e[n] ? qq.extend(r, e[n]) : qq.extend(r, t._options.request.params);
                return r
            },
            remove: function(t) {
                return delete e[t]
    ...
    _createEndpointStore: function() {
        ...
        return {
            ...
            getEndpoint: function(n) {
                return n != null && e[n] ? e[n] : t._options.request.endpoint
            },
            remove: function(t) {
                return delete e[t]
            },
...
qq.DragAndDrop = function(e) {
    ...
    function a() {
        if (s === o && !r) {
            ...
            n.dropDisabled(!1);
            t.callbacks.dropProcessing(!1, i)
        }
    }
    ...
    function c(e) {
        var r, u, f;
        t.callbacks.dropProcessing(!0);
        n.dropDisabled(!0);
        if (e.files.length > 1 && !t.multiple) {
            t.callbacks.dropProcessing(!1);
            ...
            if (qq.isFolderDropSupported(e)) {
                ...
                t.callbacks.dropProcessing(!1, e.files);
                n.dropDisabled(!1)
            }
        }
    }
    ...
    function d() {
        t.dropArea && t.extraDropzones.push(t.dropArea);
        var e, r = t.extraDropzones;
        for (e = 0; e < r.length; e += 1) h(r[e]);
        t.dropArea && (!qq.ie() || qq.ie10()) && u.attach(document, "dragenter", function(i) {
            if (!n.dropDisabled() && p(i)) {
                if (qq(t.dropArea).hasClass(t.classes.dropDisabled)) return;
                t.dropArea.style.display = "block";
                for (e = 0; e < r.length; e += 1) r[e].style.display = "block"
            }
        });
        u.attach(document, "dragleave", function(n) {
            if (t.hideDropzones && qq.FineUploader.prototype._leaving_document_out(n))
                for (e = 0; e < r.length; e += 1) qq(r[e]).hide()
        });
...
qq.UploadDropZone = function(e) {
    ...
    function u(e) {
        if (!i) {
            o ? s.attach(document, "dragover", function(e) {
                e.preventDefault()
    ...
    function a(e) {
        ...
        var t, n = e.dataTransfer,
            r = qq.safari();
        t = qq.ie10() ? !0 : n.effectAllowed !== "none";
    ...
    function l() {
        s.attach(n, "dragover", function(e) {
            ...
            t === "move" || t === "linkMove" ? e.dataTransfer.dropEffect = "move" : e.dataTransfer.dropEffect = "copy";
            e.stopPropagation();
            e.preventDefault()
        });
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _onComplete: function(e, t, n, r) {
        ...
        (!this._options.disableCancelForFormUploads || qq.isXhrUploadSupported()) && qq(this._find(i, "cancel")).hide();
        ...
        if (n.success) {
            ...
            this._options.retry.showButton && !this._preventRetries[e] && qq(i).addClass(this._classes.retryable);
    ...
    _onBeforeAutoRetry: function(e) {
        ...
        if (this._options.retry.showAutoRetryNote) {
            ...
            qq(i).setText(u);
            s === 1 && qq(t).addClass(this._classes.retrying)
        }
    },
    _onBeforeManualRetry: function(e) {
    ...
    _bindCancelAndRetryEvents: function() {
        ...
        this._disposeSupport.attach(t, "click", function(t) {
            ...
            if (qq(n).hasClass(e._classes.cancel) || qq(n).hasClass(e._classes.retry)) {
                qq.preventDefault(t);
                var r = n.parentNode;
                while (r.qqFileId == undefined) r = n = n.parentNode;
                if (qq(n).hasClass(e._classes.cancel)) e.cancel(r.qqFileId);
                else {
    ...
    _controlFailureTextDisplay: function(e, t) {
        ...
        if (n === "custom") {
            s = t[i];
            if (s) s.length > r && (o = s.substring(0, r) + "...");
            else {
            ...
            this._options.failedUploadTextDisplay.enableTooltip && this._showTooltip(e, s)
        } else n === "default" ? qq(this._find(e, "statusText")).setText(this._options.text.failUpload) : n !== "none" && this.log("failedUploadTextDisplay.mode value of '" + n + "' is not valid", "warn")
    },
...
jQuery(function(e) {
    e(window).load(function() {
        if (e("#wp_multi_file_uploader").length > 0) var t = e("#wp_multi_file_uploader"),
            n = t.data("ajaxurl"),
            r = new qq.FineUploader({
                element: e("#wp_multi_file_uploader")[0],
                debug: !1,
                request: {
                    endpoint: n,
                    params: {
                ...
                validation: {
                    allowedExtensions: t.data("mimetypes").split(","),
                    sizeLimit: parseInt(t.data("maxsize"), 10) * 1024 * 1024
                },
                callbacks: {
                    onComplete: function(t, n, r) {
                        if (r.success) {
                            var i = e("#wp_multi_file_uploader").parent("form"),
                                s = e("#wp_multi_file_uploader"),
                                o = s.data("filecount"),
                                u = r.attachmentId;
                            i.append('<input type="hidden" name="wp_multi_file_uploader[' + o + ']" value="' + u + '">');
                            s.data("filecount", o + 1)
                        }
                    }
                },
                text: {
