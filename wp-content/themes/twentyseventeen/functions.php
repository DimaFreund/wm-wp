...
function order_settings_create_menu() {
    ...
    add_menu_page('Order Price', 'Order Settings', 'administrator', 'order_settings', 'my_cool_plugin_settings_page', 'dashicons-admin-generic', 6);
        ...
        <form method="post" action="options.php">
            ...
            <table class="table-order-price" style="width: 600px; text-align: center;">
                ...
                <tr>
                    ...
                    <td><input type="text" value="<?php echo $column[$count]; ?>"></td>
                    <?php } ?>
                </tr>
...
function my_custom_init(){
    register_post_type('orders', array(
        'labels'             => array(
            ...
            'edit_item'          => 'Редактировать зака',
            'new_item'           => 'Новый заказ',
            'view_item'          => 'Посмотреть зака',
            'search_items'       => 'Найти зака',
